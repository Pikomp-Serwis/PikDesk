...
def write_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("polidesk".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../polidesk-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\polidesk\flutter\build\windows\runner\Debug\ -o . -e ..\polidesk\flutter\build\windows\runner\Debug\polidesk.exe

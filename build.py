...
hbb_name = 'polidesk' + ('.exe' if windows else '')
...
def parse_rc_features(feature):
    available_features = {
        'IddDriver': {
            'platform': ['windows'],
            'zip_url': 'https://github.com/rustdesk-org/RustDeskIddDriver/releases/download/v0.3/RustDeskIddDriver_x64.zip',
            'checksum_url': 'https://github.com/rustdesk-org/RustDeskIddDriver/releases/download/v0.3/checksum_md5',
...
def main():
    ...
    if windows:
        ...
        system2('pip3 install -r requirements.txt')
        system2(
            f'python3 ./generate.py -f ../../{res_dir} -o . -e ../../{res_dir}/polidesk-{version}-win7-install.exe')
        system2('mv ../../{res_dir}/polidesk-{version}-win7-install.exe ../..')
